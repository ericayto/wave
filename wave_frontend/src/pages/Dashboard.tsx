      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="glow-hover">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <DollarSign className="h-4 w-4 text-ocean-400" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="glow-hover">
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${
              metrics && metrics.daily_pnl >= 0 ? 'text-green-400' : 'text-red-400'
            }`}>
        ...
        <Card className="glow-hover">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Activity className="h-4 w-4 text-wave-400" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="font-medium text-white">Wave Trading Bot</div>
                <div className="text-sm text-gray-400 capitalize">
                  Status: <span className="text-green-400">{metrics?.bot_status ?? 'Ready'}</span>
                </div>
              </div>
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="glass p-4 rounded-lg text-center">
              <Shield className="w-8 h-8 text-ocean-400 mx-auto mb-2" />
              <h3 className="font-medium text-white mb-1">1. Configure Risk</h3>
              <p className="text-xs text-gray-400">Set position limits and risk parameters</p>
            </div>
            <div className="glass p-4 rounded-lg text-center">
              <TrendingUp className="w-8 h-8 text-wave-400 mx-auto mb-2" />
              <h3 className="font-medium text-white mb-1">2. Choose Strategy</h3>
              <p className="text-xs text-gray-400">Select or create a trading strategy</p>
            </div>
            <div className="glass p-4 rounded-lg text-center">
              <Bot className="w-8 h-8 text-green-400 mx-auto mb-2" />
              <h3 className="font-medium text-white mb-1">3. Start Trading</h3>
              <p className="text-xs text-gray-400">Begin paper trading with your bot</p>
            </div>
          </div>
        </CardContent>
      </Card>
